...
public class Exchange {
	...
	public boolean validateOrder(IOrder o) {
		...
		if (accounts.getTraderByID((int)o.getID()) == null) {
	...
	public void submitOrder(IOrder o, long time) {
		...
		for (ITrade t:oOutcome.getResultingTrades()) {
			...
			accounts.getTraderAccount(t.getBuyer()).withdrawMoney((int) (t.getPrice() * t.getQuantity()));
			...
			accounts.getTraderAccount(t.getSeller()).addMoney((int) (t.getPrice() * t.getQuantity()));
